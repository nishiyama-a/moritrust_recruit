    ...
    <div class="sc-inr f_wrap">
        ...
        <div class="f_box _links">
            ...
            <div class="f_link fl-wrap">
                ...
                <ul class="f_links">
                    <div class="wrap-box">
                        <li class="link"><a href="/recruit/sinsotsu/interview/1.php">用地取得</a></li>
                        <li class="link"><a href="/recruit/sinsotsu/interview/2.php">不動産開発</a></li>
                        <li class="link"><a href="/recruit/sinsotsu/interview/3.php">ホテル企画開発</a></li>
                        <li class="link"><a href="/recruit/sinsotsu/interview/4.php">設計・施工監理</a></li>
                        <li class="link"><a href="/recruit/sinsotsu/interview/5.php">営業</a></li>
                    </div>
                    <div class="wrap-box">
                        <li class="link"><a href="/recruit/sinsotsu/interview/6.php">管理</a></li>
                        <li class="link"><a href="/recruit/sinsotsu/interview/7.php">イノベーション投資</a></li>
                        <li class="link"><a href="/recruit/sinsotsu/interview/8.php">海外投資</a></li>
                        <li class="link"><a href="/recruit/sinsotsu/interview/9.php">広報</a></li>
                    </div>
                </ul>
            </div>
            <div class="f_link">
                ...
                <ul class="f_links">
                    <li class="link"><a href="/recruit/sinsotsu/crosstalk/1.php">女性社員座談会</a></li>
                    <li class="link"><a href="/recruit/sinsotsu/crosstalk/2.php">OJT×新入社員対談</a></li>
                </ul>
            </div>
            <div class="f_link">
            ...
            <div class="f_link">
                ...
                <ul class="f_links">
                    ...
                    <li class="link"><a href="https://www.mori-trust.co.jp/english/pdf/profile2021.pdf" target="_blank">パンフレット</a></li>
                </ul>
            </div>
        </div>
    </div>
