                    ...
                    <p class="clm-1 row">大学卒業後または大学院修了後の就業経験満3年以上の方。<br><span class="note">※目安であり、絶対条件ではありません</span></p>
                        ...
                        <li>
                            <div class="clm-box h-link">
                                ...
                                <p>完全週休二日制（土曜・日曜・祝日）、年末年始、<br>年次有給休暇（1日・半日・時間単位で取得可）、<br>特別休暇（慶弔等）等</p>
                            </div>
                        </li>
                        <li>
                            <div class="clm-box h-link">
                                <h2 class="head-3">給与</h2>
                                <p>当社規定による</p>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="clm-box h-link">
                                ...
                                <p>ビル経営管理士・不動産証券化マスター・宅建・簿記などの資格取得補助制度、英語研修、ビジネススキル研修、IT研修等の各種社内研修</p>
                            </div>
                        </li>
                    </ul>
                </div>
