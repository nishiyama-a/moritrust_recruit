<?php
$pageInfo = array(
  "pagetitle" => "東京ワールドゲート｜森トラストキャリア採用サイト",
);
?>
    ...
    <di class="l-wrap">
        ...
        <div class="sc-kv -page2">
            ...
            <div class="kv-ttl">
                <div class="kv-box skew-box">
                    <h1 class="kv-head skew">東京ワールドゲート</h1>
                </div>
                <p class="kv-head-en">PICK UP PROJECT 01</p>
            </div>
        </div>
        ...
        <main class="l-contents pickup" role="main" id="twg">
            <section class="l-section">
                <div class="sc-box">
                    <div class="sc-inr">
                        <h2 class="head-1">世界と日本を繋ぐ<br class="disp-sp">ゲート機能を担う</h2>
                        <p class="box-txt">
