<?php
$pageInfo = array(
  "pagetitle" => "カフェ・レストラン事業｜森トラストキャリア採用サイト",
);
?>
        ...
        <div class="sc-kv -page2">
            ...
            <div class="kv-ttl">
                <div class="kv-box skew-box">
                    <h1 class="kv-head skew">カフェ・レストラン事業</h1>
                </div>
                <p class="kv-head-en">PICK UP PROJECT 05</p>
            </div>
        </div>

        <main class="l-contents pickup" role="main" id="restaurant">
            <section class="l-section">
                <div class="sc-box">
                    <div class="sc-inr">
                        <h2 class="head-1">世界最先端の高品質なトレンドから、<br>街の声をもとにしたオリジナルメニュー開発まで</h2>
                        <p class="box-txt">
                            「カフェ・レストラン事業」は、森トラストグループが全国で展開する外資系ホテルにて長年蓄積してきた料飲メニューや空間演出のノウハウを活かし、より多様な人々へ食を通じた新たな価値提供を行うため2018年に独立事業化しました。街中への展開を始め、海外で話題のレストランを誘致したり、自社ブランドをバリエーション豊かに出店したりと、事業フィールドを広げつづけています。それぞれの街の発展に合わせた成長や変化をリアルタイムで反映させることで、その街に新たな交流を生み出し、訪れる方の感性を刺激する空間となることを目指しています。
                        </p>
                    </div>
                </div>
                <div class="sc-box">
                    <div class="mediabox-2 mediabox-l">
                        ...
                        <div class="mediabox-copy copy-r">
                            ...
                            <p>新時代にイノベーションをもたらす国際ビジネス拠点として誕生した「東京ワールドゲート」内に、日本初上陸となるニューヨーク発の人気モダンイタリアンレストラン「Scarpetta（スカルペッタ）」を誘致しました。ニューヨークと東京で連携をとりながら、料理界のアカデミー賞とも称されるジェームズ・ビアード賞にノミネートされるなど世界で注目を集めつづける名店での美食体験を、東京でもお届けしていきます。現在、開業に向けて最もこだわっているのは、東京にいながらニューヨークの「Scarpetta」で食事しているような雰囲気とお料理を味わっていただけるようにすること。世界を魅了する素材を活かしたオーセンティックなイタリアンをベースに、東京ならではのオリジナルメニューの開発も行っていきます。
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mediabox-2 mediabox-r">
                        ...
                        <div class="mediabox-copy copy-l">
                            ...
                            <p>日常の何気ないシーンのそばに、ホテルライクの上質なコーヒーとパン。思わず引き寄せられる出来たての香り、広がる笑顔。そんな心躍るポジティブなひとときを、たくさんの方に過ごしていただきたいという想いから、「GGCo.（ジージーコ―）」ブランドを展開しています。店舗ごとにCafe＆Deli、Pastry
                                ＆Bakery、Cafe＆Bakeryなど様々なスタイルで、そこに集う人々のライフスタイルやニーズに応えていきます。日々のお客様の声に耳を傾けながらその街ならではの店舗づくりや商品開発をスピード感をもって行い、トレンドを先取りしたメニューなど度々メディアに取り上げていただける人気商品も誕生しています。
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="l-section interview-video">
                <div class="sc-inr">
                    <div class="sc-box">
                        <h2 class="head-5">より広く、より深く<br>新時代の「食」に、<br class="disp-sp">新たな価値提供を</h2>
                        <p class="box-txt">
                            カフェ・レストラン事業では、ホテルで培ったノウハウを広く街中へも展開することで、食を通じた新たな価値提供を目指しています。街のなかで、その街ならではの店舗づくりを大切にしてきましたが、新しい時代のライフスタイルにより一層応えていくために、場所にとらわれない広い視野で捉えた食事業にも挑戦していこうと考えています。街中のカフェ・レストラン事業と新たな食事業はもちろん、森トラストグループのホテルレストランとも連携して、「森トラストの食」というものを磨きながら、美味しさにおいてもサービスにおいても進化しつづけていきます。
                        </p>
                    </div>
                </div>
            </section>
