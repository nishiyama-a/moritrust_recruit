<?php
$pageInfo = array(
  "pagetitle" => "01 経理部門｜森トラストキャリア採用サイト",
);
?>
    ...
    <div class="l-wrap">
        ...
        <div class="sc-kv kv-interview">
            <div class="kv-img">
                ...
                <div class="job-info">
                    <div class="skew-box">
                        <h1 class="kv-head skew">ビル事業管理部 兼 <br>(株)森トラスト・ホールディングス <br class="disp-sp">経営管理部会計グループ</h1>
                    </div>
            ...
            <div class="person">
                ...
                <p class="name">岩間 優介<span class="disp-sp">MANAGER</span></p>
                <p class="history">2005年入社<br>前職 ： 情報システム会社</p>
