                ...
                <div class="answer-wrap box-r">
                    ...
                    <div class="cut-bg-l"></div>
                        <div class="answer">
                            ...
                            <p class="txt">
                                森トラストで好きな物件は京橋トラストタワーです。京橋というと地味なイメージを持たれがちですが、中央通りに面し東京駅・銀座・日本橋いずれにも至近という森トラスト物件の中でも有数の好立地です。外観は低層階の高さを沿道のビルに揃えることで統一感のある街並みを形成しています。また、事務所とホテルの複合ビルを複数手掛けている森トラストの中では珍しく低層階にホテルがあり、華やかな雰囲気を沿道まで感じることができます。
                            </p>
                        </div>
                        <div class="answer">
                            <div class="skew-box">
