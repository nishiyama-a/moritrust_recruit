            ...
            <div class="between-box clm-box">
              <picture class="mt20">
                  ...
                  <div class="txtbox clm-copy">
                    <div class="skew-box">
                            <h4 class="skew">その場所自体が生きたものに変わっていくのを、<br>
  本当に体現・体感することができるのがデベロッパーの一番の魅力</h4>
                    </div>
                    <p class="rb-txt">森トラスト代表取締役社長<br><span>伊達 美和子</span></p>
                  </div>
            </div>
          </div>
        </section>
      ...
      <section class="l-section">
          <div class="sc-inr">
            ...
            <p class="head-txt">森トラストがどのような企業なのか、事業の魅力や人財についての考え方など、<br>
          ...
          <div class="sc-inr">
              <ul class="clm-2">
                ...
                <li>
                  ...
                  <p>新型コロナウイルスによる観光業への影響、テレワークの浸透によるオフィス賃貸市場への影響、さらには近年新たに認知されつつあるワーケーションについてなど、世間的にも関心の高まっている話題に対する考えを語ります。</p>
                  </div>
                </li>
                <li>
                  <div class="clm-box">
