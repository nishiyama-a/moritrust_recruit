<?php
$pageInfo = array(
  "pagetitle" => "レストラン・食事業｜森トラスト新卒採用サイト",
);
?>
            ...
            <section class="l-section interview-video">
                <div class="sc-inr">
                    <div class="sc-box">
                        ...
                        <p class="box-txt">
                            レストラン・食事業では、ホテルで培ったノウハウを広く街中へも展開することで、食を通じた新たな価値提供を目指しています。街のなかで、その街ならではの店舗づくりを大切にしてきましたが、新しい時代のライフスタイルにより一層応えていくために、場所にとらわれない広い視野で捉えた食事業にも挑戦していこうと考えています。街中のカフェ・レストラン事業と新たな食事業はもちろん、森トラストグループのホテルレストランとも連携して、「森トラストの食」というものを磨きながら、美味しさにおいてもサービスにおいても進化しつづけていきます。
                        </p>
                    </div>
                </div>
            </section>
