            ...
            <section class="l-section">
                <div class="sc-box">
                    <div class="sc-inr">
                        ...
                        <p class="box-txt">
                            「レストラン・食事業」は、森トラストグループが全国で展開する外資系ホテルにて長年蓄積してきた料飲メニューや空間演出のノウハウを活かし、より多様な人々へ食を通じた新たな価値提供を行うため2018年に独立事業化しました。街中への展開を始め、海外で話題のレストランを誘致したり、自社ブランドをバリエーション豊かに出店したりと、事業フィールドを広げつづけています。それぞれの街の発展に合わせた成長や変化をリアルタイムで反映させることで、その街に新たな交流を生み出し、訪れる方の感性を刺激する空間となることを目指しています。
                        </p>
                    </div>
                </div>
                <div class="sc-box">
