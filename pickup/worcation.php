        ...
        <div class="sc-kv -page2">
            ...
            <div class="kv-ttl">
                <div class="kv-box skew-box">
                    <h1 class="kv-head skew">ワーケーション事業</h1>
                </div>
                <p class="kv-head-en">PICK UP PROJECT 06</p>
            </div>
        </div>

        <main class="l-contents pickup" role="main" id="worcation">
            <section class="l-section">
                <div class="sc-box">
                    <div class="sc-inr">
                        <h2 class="head-1">ワーケーションは、<br>みんなの未来を豊かにする</h2>
                        <p class="box-txt">
                        めまぐるしく変化しつづける世の中とともに、働き方や働く場所もどんどん多様化しています。仕事の内容に応じて適切な場所を自分で選ぶという文化が受け入れられるようになり、コロナ禍によってテレワークも加速して、今では働く場所はオフィスの中に縛られないことが当たり前となってきました。都心のオフィスで働くだけでなく、リゾートで非日常感を味わいながら働くようなスタイルも、これからの時代に必要な選択肢となるのではないでしょうか。ワーケーション事業では、働くことをもっと楽しく、人生をもっと豊かにできる「新しいワークライフスタイル」を提供していきます。
                        </p>
                    </div>
                </div>
                <div class="sc-box">
                ...
                <div class="sc-box">
                    <div class="mediabox-2 mediabox-r">
                        ...
                        <div class="mediabox-copy copy-l">
                            ...
                            <p>森トラストが都心で運営する「Cozy Works」というコワーキングスペースのブランドコンセプトを、リゾート地のホテルへも続々と展開しています。都心で最先端な働き方をされているお客様の特徴の一つは、日頃いわゆるオフィスらしい空間では働いていないということ。リラックスも集中もできて、気分転換や刺激を受けることもできるような、クリエイティブを意識したデザイン空間が好まれています。このオフィス事業での経験と、ホテル事業での空間づくりのノウハウを活かして、森トラストならではのワーケーション向けのコワーキングスペースづくりを行っています。そして、仕事に欠かせない要素である快適なWi-fi環境も、国際級ホテルの水準でしっかりと整備しています。
                            </p>
                        </div>
                    </div>
                </div>
                <div class="sc-box">
                    <div class="mediabox-2 mediabox-l">
                        ...
                        <div class="mediabox-copy copy-r">
                            ...
                            <p>ワーカーにとっても、勤め先の企業にとっても、「ワーケーションを活用することはとてもハッピーなことなんだ」ということがしっかりと伝わるような取り組みにも力を入れています。例えば、ワーケーションの効果を検証するところから。森トラスト自身がワーケーションを人事制度に導入し、ワーケーションがどれだけ人のメンタルにプラスの影響を及ぼすことができるのかといったことを外部企業と提携してアプリを使って測定してみるなど。一部の限られた人だけでなく、広くワーカーの皆さんにワーケーションというスタイルを楽しんでいただけるよう、魅力づくりや裏付けにも多方面からアプローチしています。</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="l-section interview-video">
                <div class="sc-inr">
                    <div class="sc-box">
                      <h2 class="head-5">一日一日をもっと楽しく、<br>人生をより豊かにつくっていける未来を目指して</h2>
                      <p class="box-txt">誰にとってもワーケーションがもっと身近になれば、オフィスの中で働くだけでなく、リゾートで環境を変えて仕事をする、遊びも仕事も意欲的に両立させるというような多様性のあるワークライフスタイルがさらに広がっていくことでしょう。「働く」「遊ぶ」「過ごす」などの点がよりシームレスに繋がり、平日と休日の壁も越えて、一日一日をより楽しく過ごせる未来がくるのではないかと思うのです。ワーケーション事業での新しいワークライフスタイルの提供を通じて、そんな豊かな未来の実現に貢献していきたいと思います。</p>
                    </div>
                </div>
            </section>
        </main>
