    ...
    <div class="l-wrap">
        ...
        <div class="sc-kv -page2">
            ...
            <div class="kv-ttl">
                <div class="kv-box skew-box">
                    <h1 class="kv-head skew">投資事業</h1>
                </div>
                <p class="kv-head-en">OUR BUSINESS 03</p>
            </div>
        </div>
        ...
        <main class="l-contents ourbusiness" role="main" id="investment">
            <section class="l-section">
                <div class="sc-box">
                    <div class="sc-inr">
                        <h2 class="head-1">価値あるビジネスと資産への<br>投資を推進</h2>
                        <p class="box-txt">
                            森トラストグループは、今後起こりうる事業環境の変化に即応できるように、国内外の不動産投資、様々な企業への資本参加や業務提携、その他ベンチャー投資を含む広義の投資事業を積極的に推進し、グループの成長を担っています。
                        </p>
                    </div>
                </div>
                <div class="sc-box">
                    <div class="mediabox mediabox-l">
                        ...
                        <div class="mediabox-copy copy-r cut-bg-l">
                            <div class="skew-box">
                                <h4 class="skew">海外不動産投資</h4>
                            </div>
                            <p class="copy-txt">国内での投資に加え、世界的な経済変動の中でも安定した資産ポートフォリオの構築を目指して、「海外不動産への投資」を事業戦略の一つに掲げています。
                                戦略の一環として、2016年11月7日に、米国における投資事業を推進するため、米国子会社となる森アメリカ社（MORI America
                                LLC）を設立し、2017年1月に米国マサチューセッツ州ボストン市に所在するオフィスビル2棟、2019年にシリコンバレーの中心都市と言われるサンノゼ市に所在するオフィスビル3棟※を取得しました。<span
                                    class="note">※2021年7月に売却</span></p>
                        </div>
                    </div>
                    <div class="mediabox mediabox-r">
                        ...
                        <div class="mediabox-copy copy-l cut-bg-r">
                            <div class="skew-box">
                                <h4 class="skew">新イノベーション投資戦略</h4>
                            </div>
                            <p>2017年に掲げた「新イノベーション投資戦略」の下、総額200億円の投資枠を設定し、未来を見据えた新しい事業の創出を目指し、当社事業との親和性の高いスタートアップ企業への出資及び出資先との連携・協業の推進、コミュニティスペースの整備等を推進しています。当社リソースとスタートアップ企業のサービスを掛け合わせることで新たな価値創造を目指しています。
                            </p>
                        </div>
                    </div>
                    ...
                    <ul class="clm-3">
                        <li>
                            <div class="clm-box">
                                ...
                                <div class="clm-copy">
                                    <p class="point-txt">10 St. James Avenue、<br>75 Arlington Street</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="clm-box">
                                ...
                                <div class="clm-copy">
                                    <p class="point-txt">イノベーション投資取り組み事例（bitkey）</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="clm-box">
                                ...
                                <div class="clm-copy">
                                    <p class="point-txt">フューチャーアクセラレートプログラム</p>
                                </div>
                            </div>
                        </li>
                    </ul>
