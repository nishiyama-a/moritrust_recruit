        ...
        <picture class="kv-img">
          ...
          <div class="kv-ttl">
            <div class="kv-box skew-box">
              <h1 class="kv-head skew">MT TALK</h1>
            </div>
            <p class="kv-head-en">HUMAN RESOURCES 01</p>
          </div>
      </div>

      <main class="l-contents" role="main" id="mt-talk">
      <section class="l-section">
         <div class="sc-box">
            <div class="sc-inr">
              <h2 class="head-1">“究極のボトムアップ型イベント”<br>『 MT TALK 』</h2>
                <p class="box-txt">森トラストの目指すべき未来像について、各社員が自ら真剣に考え、活発に議論・表現することで、全社的な変革を創出します。また若手社員が自ら課題を見出し、立案・企画を行い、実行に向けて発表を実行する場「MT TALK fresh」も開催しています。</p>
              </div>
         </div>
              <div class="sc-box">
                <div class="mediabox mediabox-l">
                  ...
                  <div class="mediabox-copy copy-r cut-bg-l">
                    ...
                    <p class="note">※1 HR：ヒューマンリソース<br>
  ※2 HR アワードとは<br>
  企業人事、経営者、管理職や HR 関連企業、研究者らの会員で構成される日本最大の HR ネットワークである「日本の人事部」が主催し、厚生労働省や経済産業省の後援を受けて、人材開発や労務管理など、人事に関する各分野で積極的な活動・挑戦を続けている企業を表彰するもの。</p>
                ...
                <div class="mediabox mediabox-r">
                  ...
                  <div class="mediabox-copy copy-l cut-bg-r">
                    ...
                    <p>2017年から毎年1回、会社の成長に合わせてテーマを変え開催しています。年を追うごとに発表者・参加者が増え、2019年の大会後のアフターパーティーでは、256名の社員が参加し、意見交換を行いました。</p>
                  </div>
                </div>
